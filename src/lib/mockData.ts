...
for (let i = 4; i <= 22; i++) {
  ...
  mockContestantTickets.push({
    ...
    uniqueCode: `NGT-C${Math.random().toString(36).substring(7).toUpperCase()}`,
...
for (let i = 2; i <= 40; i++) {
  ...
  mockAudienceTickets.push({
    ...
    uniqueCode: `NGT-A${Math.random().toString(36).substring(7).toUpperCase()}`,
...
for (let i = 2; i <= 55; i++) {
  ...
  mockPayments.push({
    ...
    paystackReference: `PST-${Math.random().toString(36).substring(7).toUpperCase()}`,
